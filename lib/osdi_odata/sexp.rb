...
module Sexp
  ...
  class OsdiMethodCall < Treetop::Runtime::SyntaxNode
    def to_array
      return {
          :params => self.elements[1,self.elements.length].map { |e| e.to_array},
          :name => self.elements[0].to_array
      }
    end
  end

  class OsdiMethod < Treetop::Runtime::SyntaxNode
    def to_array
  ...
  class Embed < Treetop::Runtime::SyntaxNode
  ...
  class SpaceId < Treetop::Runtime::SyntaxNode
    def to_array
      return nil
    end
  end
